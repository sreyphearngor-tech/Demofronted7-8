      ...
      <div className="flex flex-col md:flex-row md:gap-10 gap-6 bg-white shadow-lg rounded-2xl p-5 border border-gray-200">
        ...
        <div className="relative w-full md:w-1/2 sm:w-[50%]">
          <img
            ...
            alt={item.brand}
          />
            <p className="absolute sm:bg-red-700 sm:text-lg sm:left-[50%] lg:left-[80%] md:left-[80%] sm:top-[20px] md:top-[20px] lg:top-[20px] text-sm top-[20px] left-[80%] text-white font-medium w-[70px] sm:w-[70px] md:w-[70px] lg:w-[70px] text-center  shadow-md rounded-lg">{item.pro}</p>
        </div>
